          ...
          <div>
            <div className="flex flex-col gap-3  indent-5 font-light">
              ...
              <p>
                ...
                không ngừng vươn lên và đã khẳng định được vị trí của mình trong
                ngành. Cho đến nay chúng tôi rất tự hào về chất lượng đã đạt
                được ở các sản phẩm trên thị trường: Mái Tôn, Thi công Nhà Xưởng
                – Nhà Thép Tiền Chế, Cửa Sắt, Cửa Cổng Sắt, Cửa Nhôm Kính, Vách
                Nhôm Kính, Dịch vụ về inox, …..Chúng tôi đã nhận cung cấp lắp
                đặt tại nhiều công trình nhà xưởng, chung cư, cao ốc văn phòng,
                bệnh viện, trường học nhà ở.
              </p>
              <p>
                {" "}
                Cùng với đội ngũ nhân viên kỹ thuật tay nghề cao lại nhiệt tình
                và năng động đảm bảo cho chất lượng công trình và sản phẩm luôn
                chắc chắn bền đẹp với thời gian.{" "}
                <span className="italic text-red-500 font-bold">
                  Cơ khí mái tôn An Nhiên
                </span>{" "}
                ...
                những ở Hà Nội mà còn còn phát triển mạnh trên các tỉnh lân cận.
              </p>
              <p>
